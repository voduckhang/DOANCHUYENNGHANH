            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user"></i>Quản lý người dùng</a>
                        ...
                        <li><i class="fa ti-angle-double-right"></i><a href="quanlynguoidung.php">Hiển thị danh sách</a></li>
                            <li><i class="fa ti-plus"></i><a href="quanlynguoidungadd.php">&nbsp;Thêm khách hàng</a></li>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-book"></i>Quản lý danh mục</a>
                        <ul class="sub-menu children dropdown-menu">            
                        <li><i class="fa ti-angle-double-right"></i><a href="quanlydanhmucsanpham.php">Hiển thị danh sách</a></li>
                            <li><i class="fa ti-plus"></i><a href="quanlydanhmucadd.php">&nbsp;Thêm sản phẩm</a></li>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-archive"></i>Quản lý sản phẩm</a>
                        <ul class="sub-menu children dropdown-menu">            
                        <li><i class="fa ti-angle-double-right"></i><a href="quanly-sanpham.php">Hiển thị danh sách</a></li>
                            <li><i class="fa ti-plus"></i><a href="quanly-sanpham-add.php">&nbsp;Thêm sản phẩm</a></li>
            ...
            <div class="top-right">
                <div class="header-menu">
                 ...
                 if(isset($_SESSION["txt_email"])){
                       ...
                       <a class="nav-link" href="../controllers/logOut_Controller.php"><i class="fa fa-power-off"></i>Logout</a>
