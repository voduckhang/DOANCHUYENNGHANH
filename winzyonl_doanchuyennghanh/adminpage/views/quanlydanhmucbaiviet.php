                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($arrStt); $i++) {
                                            ...
                                            echo ' <td>' . $arrMa[$i] . '</td>';
                                            echo ' <td>' . $arrTen[$i] . '</td>';                                                                                    
                                            echo ' <td><a href="quanly-danhmuc-chitiet.php"><button type="button" class="btn btn-link">Xem chi tiết</button></a></td>';
                                            echo '<td><a href="quanly-danhmuc-edit.php"><button type="button" class="btn btn-secondary btn-sm">Sửa</button></a>
